...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/restraintlib-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13763&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/restraintlib-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `restraintlib` can be installed with:

```
conda install restraintlib
```

It is possible to list all of the versions of `restraintlib` available on your platform with:
